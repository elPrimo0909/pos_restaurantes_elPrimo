...
$con5 = @mysqli_connect(DB_HOST, DB_USER, DB_PASS, DB_NAME);
$id3="70";
//$sql3          = "UPDATE ostemporal_mesas2 SET  titulo ='".$id."' where id='".$id3."' ";
$insert_tmp = mysqli_query($con5, "INSERT INTO  ostemporal_mesas2 (id,titulo) VALUES (null,'$id')");

$query_update = mysqli_query($con5, $insert_tmp);
